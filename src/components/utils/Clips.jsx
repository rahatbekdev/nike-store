  ...
  return (
    <>
      ...
      >
        ...
        />
        <div
          className="bg-white blur-effect-theme absolute top-11 left-11 ld:top-8 lg:left-9
        right-0 sm:top-4 sm:lest-5 opacity-100 z-[100] w-8 h-8 md:w-5 md:h-5 flex items-center
